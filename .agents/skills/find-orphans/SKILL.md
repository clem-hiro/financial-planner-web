---
name: find-orphans
description: Surface exported functions and components with no inbound edges in the function tree, excluding framework-invoked entry points (pages, route handlers, server actions, middleware). Reads docs/function-tree/function-tree.json. Use during cleanup, refactors, or pre-release dead-code sweeps.
allowed-tools: Read, Bash, Grep
argument-hint: "[--root <name>]  [--include-internal]"
---
...
>
> Cross-check with `grep -rn "<name>"` before removing.
