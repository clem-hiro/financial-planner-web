...
const statusStyles: Record<ModuleRoadmapStatus, string> = {
  ...
  beta: "border-sky-200/80 bg-sky-50/85 text-sky-900",
  complete:
    "border-emerald-200/80 bg-emerald-50/85 text-emerald-900",
};
...
export function PlaceholderModuleCard({
  ...
  return (
    <div
      ...
      className="group relative flex h-full flex-col rounded-2xl bg-linear-to-br from-white via-slate-50/40 to-sky-50/25 p-5 shadow-[0_1px_0_0_rgba(15,23,42,0.04)] ring-1 ring-slate-200/60 transition hover:ring-slate-300/80"
    >
      ...
      <div className="mt-4 flex flex-wrap items-center gap-2">
        ...
        {workInProgressTag ? (
          <span className="rounded-full bg-white/90 px-2.5 py-0.5 text-[11px] font-medium text-amber-900/90 ring-1 ring-amber-200/80">
            Work in progress
          </span>
        ) : null}
        {estimatedPhase ? (
