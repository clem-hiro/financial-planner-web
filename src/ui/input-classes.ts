...
export const fpPrimaryButtonClass =
  "rounded-full bg-linear-to-r from-[#0c192f] via-[#133359] to-[#047857] px-5 py-2.5 text-sm font-semibold tracking-tight text-white shadow-md shadow-slate-900/20 transition hover:brightness-105 active:scale-[0.99] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/35 dark:from-emerald-300 dark:via-sky-300 dark:to-teal-300 dark:text-slate-950 dark:shadow-black/25";
