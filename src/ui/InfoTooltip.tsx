...
const triggerClass: Record<Variant, string> = {
  emerald:
    "border-emerald-700/40 text-emerald-900 hover:bg-emerald-100/80 focus:ring-emerald-500",
  zinc: "border-zinc-400 text-zinc-600 hover:bg-zinc-100 focus:ring-zinc-400",
};
