...
const INVESTMENT_FIELDS: Record<string, ProposalFieldMeta> = {
  ...
  investment_income_rate_annual: { label: "Investment income rate", section: "investments", percent: true },
  ...
  contribution_start_date: { label: "Premium start date", section: "investments" },
  contribution_end_date: { label: "Premium end date", section: "investments" },
  plan_nature: { label: "Plan type", section: "investments" },
  withdrawal_annual: { label: "Yearly withdrawal", section: "investments", currency: true },
  withdrawal_monthly: { label: "Monthly withdrawal (legacy)", section: "investments", currency: true },
