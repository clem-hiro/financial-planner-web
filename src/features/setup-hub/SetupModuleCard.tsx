...
export function SetupModuleCard({
  ...
  return (
    <article
      className={`flex h-full min-w-0 flex-col rounded-2xl bg-linear-to-br from-white via-slate-50/35 to-sky-50/15 p-5 shadow-[0_1px_0_0_rgba(15,23,42,0.04)] ring-1 ${ring} transition hover:ring-slate-300/80`}
    >
      <CardTop
