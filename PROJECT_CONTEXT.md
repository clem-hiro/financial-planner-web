...
- Header: brand link ( **`/dashboard`** for clients, **`/advisor`** for advisors ), subtitle (“Private wealth clarity” vs “Advisor workspace”), optional **main nav**, client **Contact advisor**, advisor phone prompt, **How it works**, **Sign in** / **Sign out**.
...
_Last reviewed (2026-05-14): advisor workspace, key purchase/coupon workflow, verified WhatsApp contact RPC, advisor-linked client RLS, and invited-client profile repair._
