...
- **Shipped:** Monthly CPF path (`buildCpfMonthlyProjectionSeries`) forms RA at age 55 (SA then OA up to projected FRS) so Home **Projected CPF** and runway CPF breakdowns include RA; Home chart overlays estimated BRS/FRS/ERS guides and RA-vs-FRS caption (methodology topic for retirement-sum detail); CPF Investments maturity routing after SA closure (RA top-up first, excess to OA).
- **Not in scope:** live CPF APIs, actuarial CPF LIFE, exhaustive withdrawal rules; standalone Home educational RA/scenarios panel (removed — detail lives in methodology).
...
_Last reviewed (2026-07-19): **Home CPF chart** — fold estimated BRS/FRS/ERS into Projected CPF by age (guides + caption); remove standalone CPF Retirement Projection panel. Prior (2026-07-15): **Home declutter** — collapse CPF RA panel by default; Goals this month drops duplicate left-after-spend; Budget check only for over-cap/empty; header says Setup not Planning. Prior same day: removed dividend check + net-worth table. Prior (2026-07-14): **CPF age-55 RA set-aside in monthly projection**. Prior (2026-07-12): **Recommended Budget simplified for clients**. Prior same day: **Recommended Budget card compress**. Prior same day: **Recommended Budget apply safety**. Prior same day: **Budget preferences copy**. Prior same day: **Other monthly income**. Prior same day: **Home month KPIs**. Prior same day: **Top nav label** — Setup. Prior same day: **Budget page length**. Prior same day: **Profile input declutter + Budget assumptions cue**. Prior (2026-07-11): **Profile income declutter**. Prior same day: **Budget Lens IA**. Prior same day: **Methodology declutter**. Prior same day: **Setup side nav**. Prior same day: **Fold Planning into Financial setup**. Prior same day: **Home declutter** — CPF year-end. Prior same day: **Home Overview polish**. Prior (2026-07-10): **App canvas**. Prior same day: **Home hero**. Prior (2026-07-09): **Consent pending UI**. Prior same day: **Vehicle tab simplified**._
