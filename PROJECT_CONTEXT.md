...
_Last reviewed (2026-05-21): **Investment variable contribution + withdrawal planning** — investment projections now support annual contribution step-ups and planned monthly withdrawals per account, across client and advisor proposal flows. Prior (2026-05-21): **CPF rules review reminders** — CPF assumption review is now versioned against the app CPF rules baseline, with inbox and inline prompts in Setup/Wealth._
