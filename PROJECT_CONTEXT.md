...
_Last reviewed (2026-05-13): advisor operating workspace (client list RPC, linked-client RLS for financial tables, `AdvisorClientWorkspace`, `/advisor/opportunities`, `/advisor/activity` placeholders, `advisor-client-actions`), migration `20260513000000_advisor_linked_client_rls.sql`._
