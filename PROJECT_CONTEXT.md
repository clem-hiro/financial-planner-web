...
| Investments with contribution phase (until retirement / fixed duration) | **Shipped** | DB migration `20260516000000_*`; Setup → Investments; FV helpers; assumption banners; annual review reminders (inbox + stale badges) via `last_investment_review_at` + `investment-review.ts`. |
