...
| Profile income / CPF assumptions | **Shipped** | Setup **profile** tab — income, bonus, birth date, CPF salary path; onboarding sync banner. **Lifestyle Profile** preferences (lifestyle, typical food spend, money management style) live here as long-lived budgeting assumptions — no recommended allocation numbers. No retirement fields. |
