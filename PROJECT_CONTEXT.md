...
| Budget lines, overrides, strategy insights, recurring budget review | **Shipped** | Repositories + `src/domain/finance/budget*.ts`; budget workspace now includes a month-by-month review workflow for planned categories, actual spend, temporary overrides, unbudgeted spend, and scheduled/inactive lines. |
...
_Last reviewed (2026-05-21): **Budget review workflow** — budget workspace now surfaces a recurring monthly review for planned categories, actual spend, temporary overrides, unbudgeted spend, and scheduled/inactive lines. Prior (2026-05-20): **Onboarding UX** — gross salary + live CPF take-home preview, bonus-month selector, back navigation, illustrated plan wording; `annual_bonus_months` migration; onboarding→module sync doc._
