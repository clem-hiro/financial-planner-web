...
#### `updateHousingLoan` — function, L103

- calls: `[external] @supabase/postgrest-js`, `[external] @supabase/supabase-js`
- called by: `src/server/actions.ts#updateHousingLoanAction`

#### `deleteHousingLoan` — function, L143
