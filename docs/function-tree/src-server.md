...
| [`src/server/actions.ts`](#src-server-actions-ts) | `server-action` | 49 | 328 |
...
#### `toClientErrorMessage` — function, L103 _(server-action)_
...
#### `updateInvestmentAction` — function, L180 _(server-action)_
...
#### `deleteInvestmentAction` — function, L248 _(server-action)_
...
#### `confirmInvestmentReviewAction` — function, L280 _(server-action)_
...
#### `confirmCpfRulesReviewAction` — function, L304 _(server-action)_
...
#### `parseCashAccountForm` — function, L326 _(server-action)_

- calls: `[external] zod`
- called by: `src/server/actions.ts#createCashAccountAction`, `src/server/actions.ts#updateCashAccountAction`

#### `createCashAccountAction` — function, L339 _(server-action)_
...
#### `updateCashAccountAction` — function, L359 _(server-action)_
...
#### `deleteCashAccountAction` — function, L382 _(server-action)_
...
#### `createLiabilityAction` — function, L404 _(server-action)_
...
#### `updateLiabilityAction` — function, L432 _(server-action)_
...
#### `deleteLiabilityAction` — function, L468 _(server-action)_
...
#### `optionalYearMonth` — function, L492 _(server-action)_

- calls: `[external] zod`
- called by: `src/server/actions.ts#createVehicleAction`, `src/server/actions.ts#updateVehicleAction`

#### `createVehicleAction` — function, L501 _(server-action)_
...
#### `updateVehicleAction` — function, L691 _(server-action)_
...
#### `deleteVehicleAction` — function, L882 _(server-action)_
...
#### `createGoalAction` — function, L901 _(server-action)_
...
#### `reorderFinancialGoalAction` — function, L957 _(server-action)_
...
#### `updateGoalAction` — function, L989 _(server-action)_
...
#### `createBudgetLineAction` — function, L1052 _(server-action)_
...
#### `coerceLifestyle` — function, L1148 _(server-action)_

- called by: `src/server/actions.ts#applyGuidedBudgetLinesAction`

#### `coerceStrategy` — function, L1156 _(server-action)_

- called by: `src/server/actions.ts#applyGuidedBudgetLinesAction`

#### `coerceFoodBand` — function, L1164 _(server-action)_

- called by: `src/server/actions.ts#applyGuidedBudgetLinesAction`

#### `applyGuidedBudgetLinesAction` — function, L1185 _(server-action)_
...
#### `updateBudgetLineAmountAction` — function, L1272 _(server-action)_
...
#### `deleteBudgetLineAction` — function, L1302 _(server-action)_
...
#### `setBudgetMonthOverrideAction` — function, L1323 _(server-action)_
...
#### `clearBudgetMonthOverrideAction` — function, L1360 _(server-action)_
...
#### `updateBudgetLineScheduleAction` — function, L1387 _(server-action)_
...
#### `upsertCpfBalanceAction` — function, L1445 _(server-action)_
...
#### `clearCpfBalanceAction` — function, L1503 _(server-action)_
...
#### `createCpfInvestmentAction` — function, L1519 _(server-action)_
...
#### `deleteCpfInvestmentAction` — function, L1561 _(server-action)_
...
#### `parseHousingPaymentForm` — function, L1580 _(server-action)_
...
#### `revalidateHousingPaths` — function, L1646 _(server-action)_
...
#### `parseOptionalMoneyField` — function, L1654 _(server-action)_

- called by: `src/server/actions.ts#createHousingPropertyAction`

#### `parseOptionalPurchaseYear` — function, L1663 _(server-action)_

- called by: `src/server/actions.ts#createHousingPropertyAction`

#### `normalizeOptionalMmyy` — function, L1670 _(server-action)_

- called by: `src/server/actions.ts#optionalYearMonthOrMmyy`

#### `optionalYearMonthOrMmyy` — function, L1688 _(server-action)_

- calls: `[external] zod`, `src/server/actions.ts#normalizeOptionalMmyy`
- called by: `src/server/actions.ts#createHousingPropertyAction`

#### `insertPropertyForLoan` — function, L1699 _(server-action)_
...
#### `createHousingPropertyAction` — function, L1723 _(server-action)_
...
#### `updateHousingPropertyAction` — function, L1999 _(server-action)_
...
#### `deleteHousingPropertyAction` — function, L2050 _(server-action)_
...
#### `createHousingLoanAction` — function, L2066 _(server-action)_
...
#### `createHousingLoanQuickAction` — function, L2188 _(server-action)_
...
#### `updateHousingLoanAction` — function, L2445 _(server-action)_
...
#### `deleteHousingLoanAction` — function, L2564 _(server-action)_
